...
public class SetStructureBlockSerializer_v754 implements JavaPacketSerializer<SetStructureBlockPacket> {
    ...
    @Override
    public void serialize(ByteBuf buffer, JavaCodecHelper helper, SetStructureBlockPacket packet) throws PacketSerializeException {
    ...
    @Override
    public void deserialize(ByteBuf buffer, JavaCodecHelper helper, SetStructureBlockPacket packet) throws PacketSerializeException {
