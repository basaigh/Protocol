...
public class RecipeSerializer_v754 implements JavaPacketSerializer<RecipePacket> {
    ...
    @Override
    public void serialize(ByteBuf buffer, JavaCodecHelper helper, RecipePacket packet) throws PacketSerializeException {
    ...
    @Override
    public void deserialize(ByteBuf buffer, JavaCodecHelper helper, RecipePacket packet) throws PacketSerializeException {
