...
public class MapItemDataSerializer_v754 implements JavaPacketSerializer<MapItemDataPacket> {
    ...
    @Override
    public void serialize(ByteBuf buffer, JavaCodecHelper helper, MapItemDataPacket packet) throws PacketSerializeException {
    ...
    @Override
    public void deserialize(ByteBuf buffer, JavaCodecHelper helper, MapItemDataPacket packet) throws PacketSerializeException {
