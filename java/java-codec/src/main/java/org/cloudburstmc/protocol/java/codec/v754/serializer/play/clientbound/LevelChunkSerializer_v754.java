...
public class LevelChunkSerializer_v754 implements JavaPacketSerializer<LevelChunkPacket> {
    ...
    @Override
    public void serialize(ByteBuf buffer, JavaCodecHelper helper, LevelChunkPacket packet) throws PacketSerializeException {
    ...
    @Override
    public void deserialize(ByteBuf buffer, JavaCodecHelper helper, LevelChunkPacket packet) throws PacketSerializeException {
